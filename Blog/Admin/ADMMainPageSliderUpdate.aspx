<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ADMMainPageSliderUpdate.aspx.cs" Inherits="Blog.Admin.ADMMainPageSliderUpdate" %>
                                            ...
                                            <div class="row">
                                                <table class="table table-striped table-condensed table-bordered">
                                                    ...
                                                    <tr>
                                                        <th>Yazı Yönü</th>
                                                        <td>
                                                            <asp:DropDownList ID="drpDirection" runat="server" CssClass="form-control">
                                                                <asp:ListItem Selected="True" Text="Sağ" Value="right"></asp:ListItem>
