<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ADMQuestion.aspx.cs" Inherits="Blog.Admin.ADMQuestion" %>
                                ...
                                <div class="row">
                                    <div class="widget-box">
                                        <div class="widget-header">
                                            <h4 class="widget-title smaller">Hakkımda
                                            ...
                                            <div id="dvToolboxImages" runat="server" class="widget-toolbox pull-right">
                                                <a href="javascript:void(0)" onclick="ShowModal('/Admin/ADMQuestionUpdate.aspx','lg',540,'Yeni Ekle','btnRefreshList')" class="btn btn-sm btn-success"><i class="ace-icon fa fa-plus"></i>Yeni Ekle</a>
                                            </div>
                                        </div>
                                            ...
                                            <div class="widget-main no-padding">
                                                <div class="table-responsive">
                                                    <table class="table table-bordered table-striped table-hover">
                                                        ...
                                                        <tbody>
                                                            <asp:Repeater ID="rptrQuestion" runat="server" OnItemCommand="rptrQuestion_ItemCommand" OnItemDataBound="rptrQuestion_ItemDataBound" >
                                                                <ItemTemplate>
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <a href="javascript:void(0)" onclick="ShowModal('/Admin/ADMQuestionUpdate.aspx?ID=<%#Eval("ID")%>','lg',540,'Güncelle','btnRefreshList')" class="tooltip-info" data-rel="tooltip" data-original-title="Güncelle"><i class="ace-icon fa fa-pencil green bigger-150"></i></a>
                                                                        </td>
                                                                    </tr>
                                                                </ItemTemplate>
                                                            </asp:Repeater>
