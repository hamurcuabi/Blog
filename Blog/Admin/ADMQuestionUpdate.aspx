<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ADMQuestionUpdate.aspx.cs" Inherits="Blog.Admin.ADMQuestionUpdate" ValidateRequest="false" %>
...
<body class="no-skin">
                                            ...
                                            <div class="row">
                                                <table class="table table-striped table-condensed table-bordered">
                                                    ...
                                                    <tr>
                                                        <th>Sorulan Soru</th>
                                                        <td>
                                                            <asp:TextBox ID="txtQuestion" runat="server" CssClass="form-control"></asp:TextBox></td>
                                                    </tr>

                                                    <tr>
                                                        <th>Verdiğiniz Cevap</th>
                                                        <td>
    ...
    <script type="text/javascript">
        ...
        function InitializePage() {
            ...
            $('#dvDescriptionShort').ace_wysiwyg({
                toolbar:
                    [
                        'font',
                        null,
            ...
            $('#dvDescriptionShort').html($('#hdnDescriptionShort').val());
            $('.wysiwyg-choose-file').css('display', 'none');
        }
        function SaveToHdn() {
            $('#hdnDescription').val($('#dvDescription').html());
            $('#hdnDescriptionShort').val($('#dvDescriptionShort').html());
        }
        InitializePage();
    </script>
    <script>
