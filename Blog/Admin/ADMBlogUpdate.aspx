<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ADMBlogUpdate.aspx.cs" Inherits="Blog.Admin.ADMBlogUpdate" ValidateRequest="false" %>
                                            ...
                                            <div class="row">
                                                <table class="table table-striped table-condensed table-bordered">
                                                    ...
                                                    <tr>
                                                        <th>Alt</th>
                                                        <td>
                                                            <asp:TextBox ID="txtAlt" runat="server" CssClass="form-control"></asp:TextBox></td>
                                                    </tr>
                                                    <tr>
                                                        <th>Başlık</th>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        <th>Kategori Seçiniz</th>
                                                        <td><asp:DropDownList runat="server" ID="drpCatergori"></asp:DropDownList></td>
                                                    ...
                                                    <tr>
                                                        <th>Ana Yazı</th>
                                                        <td>
                                                            <div id="dvDescription" runat="server" class="wysiwyg-editor">
                                                            </div>
                                                     ...
                                                     <tr>
                                                        <th>VİDEO</th>
                                                        <td>
                                                            <asp:TextBox ID="txtVideo" runat="server" CssClass="form-control"></asp:TextBox></td>
                                                    </tr>
                                                    <tr>
                                                        <th colspan="2" style="text-align: right;">
                                                            ...
                                                            <asp:LinkButton ID="btnSave" runat="server" OnClick="btnSave_Click" OnClientClick="SaveToHdn();" CssClass="btn btn-sm btn-success"><i class="fa fa-floppy-o"></i> Kaydet</asp:LinkButton></th>
                                                    </tr>
                                                </table>
                                            </div>
                                        </div>
