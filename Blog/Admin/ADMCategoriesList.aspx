<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ADMCategoriesList.aspx.cs" Inherits="Blog.Admin.ADMCategoriesList" %>
                                ...
                                <div class="row">
                                    <div class="widget-box">
                                        <div class="widget-header">
                                            <h4 class="widget-title smaller">Kategori
                                                 <asp:Literal runat="server" ID="lblCountCategories"> ( 0 )</asp:Literal>
                                              
                                            </h4>
                                            <div id="dvToolboxImages" runat="server" class="widget-toolbox pull-right">
                                                <a href="javascript:void(0)" onclick="ShowModal('/Admin/ADMCategoriesUpdate.aspx','lg',540,'Yeni Ekle','btnRefreshList')" class="btn btn-sm btn-success"><i class="ace-icon fa fa-plus"></i>Yeni Ekle</a>
                                            </div>
                                        </div>
                                            ...
                                            <div class="widget-main no-padding">
                                                <div class="table-responsive">
                                                    <table class="table table-bordered table-striped table-hover">
                                                        ...
                                                        <tbody>
                                                            <asp:Repeater ID="rptCategories" runat="server" OnItemCommand="rptCategories_ItemCommand" OnItemDataBound="rptCategories_ItemBound">
                                                                ...
                                                                <ItemTemplate>
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <a href="javascript:void(0)" onclick="ShowModal('/Admin/ADMCategoriesUpdate.aspx?ID=<%#Eval("ID")%>','lg',540,'Güncelle','btnRefreshList')" class="tooltip-info" data-rel="tooltip" data-original-title="Güncelle"><i class="ace-icon fa fa-pencil green bigger-150"></i></a>
                                                                        </td>
                                                                    </tr>
                                                                </ItemTemplate>
                                                            </asp:Repeater>
