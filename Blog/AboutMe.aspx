<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AboutMe.aspx.cs" Inherits="Blog.AboutMe" %>

<%@ Import Namespace="Blog.Code" %>


<%@ Register Src="~/Controler/Footer.ascx" TagPrefix="uc1" TagName="Footer" %>
<%@ Register Src="~/Controler/Header2.ascx" TagPrefix="uc1" TagName="Header2" %>
<%@ Register Src="~/Controler/SliderAboutMe.ascx" TagPrefix="uc1" TagName="SliderAboutMe" %>
...
<head>
   ...
   <title>PsikoBlog | Hakkımda</title>    
    <!-- Plugins CSS -->
...
<body data-spy="scroll" data-darget=".navbar-seconday">
   ...
   <uc1:SliderAboutMe runat="server" id="SliderAboutMe" />
    ...
    <div class="container">
         <div class="container mb30">
            <div class="row">
               ...
               <div id="accordion" class="mb70" role="tablist" aria-multiselectable="true">
                   ...
                   <asp:Repeater ID="rptQuestion" runat="server"><ItemTemplate>
                <div class="card mb10">
                  <div class="card-header accordion-header" role="tab" id="headingOne">
                        <h5 class="mb-0">
                            <a class="collapsed" data-toggle="collapse" data-parent="#accordion" href='#collapse<%# Eval("ID") %>' aria-expanded="true" aria-controls="collapseOne">
                                <%# Eval("TITLE") %>
                            </a>
                        </h5>
                    </div>

                    <div id='collapse<%# Eval("ID") %>' class="collapse" role="tabpanel" aria-labelledby="headingOne">
                        <div class="card-body">
                            <%# Eval("ANSWER") %>
                        </div>
                    </div>
     ...
     <div class="bg-faded pt20 pb20">
            <div class="container">
              <div class="row">
                  <div class="col-md-8 ml-auto mr-auto text-center">
                        <h2 class="text-uppercase">Sorunuz Var mı?</h2>
                <p>
                        Benim hakkımda ya da piskoloji hakkındaki sorularınızı sorabilirsiniz. 
                    </p>
                    <a href="/Iletisim/2" class="btn btn-lg btn-rounded btn-primary">Hadİ Sor</a>
                  </div>
              </div>
            </div>
        </div>
