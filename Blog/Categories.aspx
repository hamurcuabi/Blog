<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Categories.aspx.cs" Inherits="Blog.Categories" %>

<%@ Import Namespace="Blog.Code" %>
<%@ Register Src="~/Controler/Footer.ascx" TagPrefix="uc1" TagName="Footer" %>
<%@ Register Src="~/Controler/Header5.ascx" TagPrefix="uc1" TagName="Header5" %>
...
<html lang="en">
     <head>
       ...
       <title>PsikoBlog | Kategoriler</title>        
        <!-- Plugins CSS -->
    ...
    <body>
        ...
        <div class="site-overlay"></div>
                <uc1:Header5 runat="server" ID="Header5" /><!-- HEADER -->
          ...
          <div class="container mb30">
            <div class="row">
                <div class="col-md-9" >
                    <asp:Repeater ID="rptPostTitle" runat="server">
                            <ItemTemplate>
                                <!--Foto-->
                    ...
                    <div class="mb40">
                        ...
                        <ul class="list-unstyled categories">
                            <asp:Repeater ID="rptrCategories" runat="server">
                             <ItemTemplate>
                                 <li>
                                   <a href='<%#string.Format("{0}",Helper.SEOUrl(Eval("TITLE").ToString()))%>'>  <%# Eval("TITLE")%>  (<%# (GetCountBlog(Eval("ID").ToString()))%>)</a>
                               </li> 
                             </ItemTemplate>
                            </asp:Repeater>
                        </ul>
