...
<%@ Register Src="~/Controler/Header.ascx" TagPrefix="uc1" TagName="Header" %>
<%@ Register Src="~/Controler/Slider.ascx" TagPrefix="uc1" TagName="Slider" %>
...
<html lang="en">
    <head>
        ...
        <title>PsikoBlog | Anasayfa</title>    
        <!-- Plugins CSS -->
...
<uc1:Header runat="server" ID="Header" /><!-- HEADER -->
<uc1:Slider runat="server" ID="Slider" /><!-- SLIDER -->
                    ...
                    <asp:Repeater ID="rptPost" runat="server">
                        ...
                        <div class="post-content">
                         ...
                         <p><%# Server.HtmlDecode(Eval("MAINTEXT").ToString()) %></p>
                           ...
                           <!-- <a href='<%#string.Format("/blog/{0}",Helper.SEOUrl(Eval("TITLE").ToString()))%>'" class="btn btn-outline-secondary">Daha Fazla</a>-->
                        </div>
