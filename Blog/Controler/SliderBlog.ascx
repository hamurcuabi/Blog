<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SliderBlog.ascx.cs" Inherits="Blog.Controler.SliderBlog" %>
            ...
            <div id="rev_slider_8_1" class="rev_slider fullscreenbanner" style="display:none;" data-version="5.4.1">
                <ul>	<!-- SLIDE  -->
                    <li data-index="rs-16" data-transition="fade" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="Power4.easeOut" data-easeout="Power4.easeOut" data-masterspeed="default"  data-thumb="http://works.themepunch.com/revolution_5_3/wp-content/"  data-rotate="0"  data-saveperformance="off"  data-title="Example One" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                        <!-- MAIN IMAGE -->
                        <img src="/images/rev-images/transparent.png" data-bgcolor='#ffffff'' style='background:#ffffff' alt=""  data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="off" class="rev-slidebg" data-no-retina>
                        <!-- LAYERS -->
                        ...
                        <div class="tp-caption  " 
                             ...
                             style="z-index: 5;"><img src="/images/rev-images/blurbg7.jpg" alt="" data-ww="['full-proportional','fullproportional','full-proportional','full-proportional']" data-hh="['full-proportional','full-proportional','full-proportional','full-proportional']" width="1920" height="1080" data-no-retina> </div>

                        <!-- LAYER NR. 2 -->
                        <div class="tp-caption   tp-resizeme  particale-title" 
                             id="slide-16-layer-6" 
                             data-x="['center','center','center','center']" data-hoffset="['0','0','0','0']" 
                             data-y="['middle','middle','middle','middle']" data-voffset="['-110','-110','-130','-130']" 
                             data-fontsize="['80','80','50','35']"
                             data-lineheight="['100','100','60','60']"
                             data-width="1170"
                             data-height="none"
                             data-whitespace="nowrap"
                             ...
                             style="z-index: 6; white-space: nowrap; font-size: 50px; line-height: 60px; font-weight: 700; color: rgba(4,37,60,1);letter-spacing:-3px;text-transform:capitalize;"><span style="color:rgba(0,0,0,0.3);"></span> <br>BLOG</div>
                        ...
                        <div class="tp-caption   tp-resizeme" 
                             ...
                             style="z-index: 7; min-width: 900px; max-width: 900px; white-space: normal; font-size: 25px; line-height: 35px; font-weight: 400; color: rgba(4,37,60,1);font-family:'Lato', sans-serif;letter-spacing:0px;"><h1><asp:Label runat="server" ID="lblTitle"></asp:Label></h1></div>
